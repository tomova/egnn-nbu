...
class DipolePredictorEGNN(nn.Module):
    def __init__(self):
        super(DipolePredictorEGNN, self).__init__()
        ...
        # Use fully connected layers after pooling across nodes
...
for epoch in range(1000):
    ...
    with torch.no_grad():
        ...
        if avg_val_loss_l1 < best_val_loss:
            ...
            torch.save(net.state_dict(), 'best_model_egnn_dipole_mae128.pth')


# Testing
net.load_state_dict(torch.load('best_model_egnn_dipole_mae128.pth'))
net.eval()
with torch.no_grad():
    test_loss_l1 = 0
    test_loss_mse = 0
