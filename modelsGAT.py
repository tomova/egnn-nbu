...
# Define models
dipole_model = EquivariantGNN_GAT(num_node_features, hidden_dim, output_dim_dipoles, num_node_types).to(device)  # 3 for dipole
quadrupole_model = EquivariantGNN_GAT(num_node_features, hidden_dim, output_dim_quadrupoles, num_node_types).to(device)  # 6 for quadrupole
