...
for epoch in range(100):
    ...
    if valid_loss < best_valid_loss:
        ...
        epochs_no_improve = 0
        # Save the model
        torch.save({'dipole_model_state_dict_SH': dipole_model.state_dict(),
                    'quadrupole_model_state_dict_SH': quadrupole_model.state_dict()}, 'best_model_SH.pth')
    else:
        epochs_no_improve += 1
...
# Load the best model
checkpoint = torch.load('best_model_SH.pth')
dipole_model.load_state_dict(checkpoint['dipole_model_state_dict_SH'])
quadrupole_model.load_state_dict(checkpoint['quadrupole_model_state_dict_SH'])
...
print(f'Dipole Model _SH: MAE = {mae_dipole}, R^2 = {r2_dipole}')
print(f'Quadrupole Model _SH: MAE = {mae_quadrupole}, R^2 = {r2_quadrupole}')